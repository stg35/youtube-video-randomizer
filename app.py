...
def main():
    ...
    for ID in playlistsID:
        #maxResults = 3
        request_playlist = requests.get('https://www.googleapis.com/youtube/v3/playlistItems?part=snippet%2CcontentDetails&maxResults=4&playlistId={0}&key={1}'.format(ID, API_KEY))
